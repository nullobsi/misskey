...
<div class="_formRoot">
	...
	<FormSwitch v-model="showTimelineReplies" class="_formBlock">{{ $ts.flagShowTimelineReplies }}<template #desc>{{ $ts.flagShowTimelineRepliesDescription }}</template></FormSwitch>
